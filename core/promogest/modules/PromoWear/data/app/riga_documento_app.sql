...
DROP FUNCTION promogest.RigaDocumentoSet(varchar, bigint, bigint, decimal(16,4), decimal(16,4), decimal(16,4), decimal(15,6), varchar, decimal(8,4), varchar, bigint, bigint, bigint, bigint, bigint, text);
CREATE OR REPLACE FUNCTION promogest.RigaDocumentoSet(varchar, bigint, bigint, decimal(16,4), decimal(16,4), decimal(16,4), decimal(15,6), varchar, decimal(8,4), varchar, bigint, bigint, bigint, bigint, bigint, text) RETURNS promogest.resultid AS '
    DECLARE
        -- Parametri contesto
        _schema                         ALIAS FOR $1;
    ...
    BEGIN
        ...
        SELECT INTO _ret * FROM promogest.RigaDocumentoInsUpd(_schema, _idutente, _id, _valore_unitario_netto, _valore_unitario_lordo, _quantita, _moltiplicatore, _applicazione_sconti, _percentuale_iva,
                                                              _descrizione, _id_listino, _id_magazzino, _id_articolo, _id_multiplo, _id_testata_documento, _dummy);           
...
DROP FUNCTION promogest.RigaDocumentoDel(varchar, bigint, bigint);
CREATE OR REPLACE FUNCTION promogest.RigaDocumentoDel(varchar, bigint, bigint) RETURNS promogest.resultid AS '
    DECLARE
        -- Parametri contesto
        _schema                 ALIAS FOR $1;
        _idutente               ALIAS FOR $2;
...
CREATE OR REPLACE FUNCTION promogest.RigheDocumentoDel(varchar, bigint, bigint) RETURNS promogest.resultid AS '
    DECLARE
        -- Parametri contesto
        _schema                     ALIAS FOR $1;
        _idutente                   ALIAS FOR $2;
...
DROP FUNCTION promogest.RigaDocumentoGet(varchar, bigint, bigint);
DROP FUNCTION promogest.RigaDocumentoSel(varchar, bigint, varchar, bigint, bigint, bigint);
DROP FUNCTION promogest.RigaDocumentoSelCount(varchar, bigint, varchar, bigint, bigint, bigint);

DROP TYPE promogest.riga_documento_type;
DROP TYPE promogest.riga_documento_sel_type;
DROP TYPE promogest.riga_documento_sel_count_type;

CREATE TYPE promogest.riga_documento_type AS (
     id                         bigint
...
CREATE TYPE promogest.riga_documento_sel_type AS (
     id                                     bigint
    ,valore_unitario_netto                  decimal(16,4)
    ,valore_unitario_lordo                  decimal(16,4)
    ,quantita                               decimal(16,4)
...
CREATE TYPE promogest.riga_documento_sel_count_type AS (
    count       bigint
);

CREATE OR REPLACE FUNCTION promogest.RigaDocumentoGet(varchar, bigint, bigint) RETURNS SETOF promogest.riga_documento_type AS '
    DECLARE
        -- Parametri contesto
        _schema                 ALIAS FOR $1;
        _idutente               ALIAS FOR $2;
...
CREATE OR REPLACE FUNCTION promogest.RigaDocumentoSel(varchar, bigint, varchar, bigint, bigint, bigint) RETURNS SETOF promogest.riga_documento_sel_type AS '
    DECLARE
        -- Parametri contesto
        _schema                     ALIAS FOR $1;
        _idutente                   ALIAS FOR $2;
    ...
    BEGIN
        ...
        sql_statement:= \'SELECT * FROM v_riga_documento_completa \';
        sql_cond:=\'\';
...
CREATE OR REPLACE FUNCTION promogest.RigaDocumentoSelCount(varchar, bigint, varchar, bigint, bigint, bigint) RETURNS SETOF promogest.riga_documento_sel_count_type AS '
    DECLARE
        -- Parametri contesto
        _schema                     ALIAS FOR $1;
        _idutente                   ALIAS FOR $2;
    ...
    BEGIN
        ...
        sql_statement:= \'SELECT COUNT(id) FROM v_riga_documento_completa \';
        sql_cond:=\'\';
