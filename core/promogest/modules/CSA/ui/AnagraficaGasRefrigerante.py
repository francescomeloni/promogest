...
class AnagraficaGasRefrigerante(Anagrafica):
    ...
    def __init__(self):
        Anagrafica.__init__(self, 'Promogest - Anagrafica gas refrigerante',
                            '_Gas refrigerante',
    ...
    def refresh(self):
        ...
        self.numRecords = GasRefrigerante().count(denominazione=denominazione)

        self._refreshPageCount()

        # Let's save the current search as a closure
        def filterClosure(offset, batchSize):
            return GasRefrigerante().select(denominazione=denominazione,
...
class AnagraficaGasRefrigeranteFilter(AnagraficaFilter):
