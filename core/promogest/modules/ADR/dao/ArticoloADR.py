...
class ArticoloADR(Base, Dao):
    try:
        ...
        __table__ = Table(
            ...
            Column('percentuale_carbonio', Numeric(8, 4), nullable=True),
            Column('percentuale_cov', Numeric(8, 4), nullable=True),
            Column('percentuale_secco', Numeric(8, 4), nullable=True),
