...
from promogest.dao.TestataCommesse import TestataCommesse
from promogest.dao.RigaCommesse import RigaCommesse
...
class AnagraficaCommessa(Anagrafica):
    """ Anagrafica Comesse """
...
class AnagraficaCommesseFilter(AnagraficaFilter):
    ...
    def __init__(self, anagrafica):
        AnagraficaFilter.__init__(self,
                          anagrafica,
                          'anagrafica_commesse_filter_table',
                          gladeFile='_anagrafica_commesse_elements.glade')
