...
#        column.connect("clicked", self._changeOrderBy, 'riferimento')
    ...
    def refresh(self):
        ...
        incaricato = prepareFilterString(self.incaricato_combobox_filter_entry.get_child().get_text())
        autore = prepareFilterString(self.autore_combobox_filter_entry.get_child().get_text())
